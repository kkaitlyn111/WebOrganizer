...
#SBATCH --account=nlp
#SBATCH --output=/juice5b/scr5b/kaitwang/stats305c/WebOrganizer/milestone4/m4/logs/val_eq_%A_%a.out
#SBATCH --error=/juice5b/scr5b/kaitwang/stats305c/WebOrganizer/milestone4/m4/logs/val_eq_%A_%a.err
...
echo "=== validation-eq $RID on $(hostname) ==="
nvidia-smi --query-gpu=name,memory.total --format=csv

.venv/bin/python3 milestone4/m4/scripts/09b_run_validation_equal_tokens.py \
    --run "$RID" --budget 150000000 --wandb-project m4-validation-eq
