...
#SBATCH --account=nlp
#SBATCH --output=logs/m4_entities_%A_%a.out
#SBATCH --error=logs/m4_entities_%A_%a.err
...
../.venv/bin/python3 06_extract_entities.py --shards "${SHARD}"
